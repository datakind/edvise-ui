  ...
  return (
    <div
      className={classNames(
        className,
        'flex w-full rounded-lg bg-gray-200',
      )}
    >
    ...
    <div className="flex">
      ...
      (<div className="flex w-full flex-col h-fit">
        <h5 className="mb-3 text-lg font-bold text-black">No Files</h5>
              ...
              <div className="flex w-full flex-col h-fit">
        <h5 className="mb-3 text-lg font-bold text-black">Validated Files</h5>
        <ul className="list-inside">
          {fileList.map((f) =>
                <li className="text-base leading-relaxed text-black" key={f.name}>
      ...
      (<div className="flex w-full flex-col h-fit">
        <h5 className="mb-3 text-lg font-bold text-black">No Batches</h5>
              ...
              <div className="flex w-full flex-col h-fit">
        <h5 className="mb-3 text-lg font-bold text-black">Created Batches</h5>
        <ul className="list-inside">
          {batchList.map((b) =>
                <li className="text-base leading-relaxed text-black" key={b.name}>
                  <div className="flex justify-between w-full">
                    <div className="flex">
                    <button>
                      <DocumentDuplicateIcon
