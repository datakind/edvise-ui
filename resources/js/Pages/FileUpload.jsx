    ...
    >
      <div className="w-full flex flex-col" id="main_area">
        ...
        {processing ? (
          ...
          <div>
            <div className="flex items-center justify-center">
              Please upload both course-level and student semester files to
              generate predictions.
            </div>
            <div className="flex items-center justify-center w-full">
              Data can be uploaded to train a model or start an inference run
              for new dashboard results.
            </div>
            ...
            <div className="flex py-12 w-full mx-auto pl-24">
              {files == undefined || files.length == 0 ? (
                ...
                <ul
                  className="flex flex-col gap-y-1 justify-stretch items-stretch font-semibold text-gray-600 w-full pr-24"
                  id="files-show"
                >
            ...
            <div id="result_area" className="flex">
              {' '}
            </div>
            <div className="flex justify-end items-end pr-24">
              <button
                ...
                disabled={
                  constructErrMessage(fileStatus) == '' &&
                  files !== undefined &&
                  files.length !== 0
                    ? ''
                    : true
