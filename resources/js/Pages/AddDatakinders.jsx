...
if (inst == undefined) {
    ...
    document.getElementById("result_area").innerHTML = "Placeholder. This page does not currently do anything.";
...
<h1 className="text-2xl font-bold pb-12"> Add emails for accounts that should have access type DATAKINDER</h1>
...
<div id="form_contents" className="flex flex-col">
  ...
  <div id="add_one_user" className="flex -mx-3 mb-2">
    <div className="w-1/2 px-3 mb-6">
      ...
      <input name="user-0" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="email" placeholder="j.smith@datakind.org"></input>
    </div>
