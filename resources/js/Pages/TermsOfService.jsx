        ...
        <div className="prose lg:prose-xl">
          ...
          <section className="mb-6">
            ...
            <p>
              ...
              made by us to the Terms of Use.
            </p>
            <p>
              The Company reserves the right to modify fees at any time for the
              applicable services upon notice to you. Any such modified fees
              shall be applicable for all Orders and renewals thereof after the
              date of such notice.
            </p>
          </section>
          <section className="mb-6">
            ...
            <p>
              ...
              (“User Password”) that is unique and entirely different from your
              User Email. You agree that you will never divulge or share your
              User Email or User Password with anyone for any reason. You agree
              not to allow anyone to access or use your user account or provide
              them with your login information to do so.
            </p>
            <p>
              Submissions of data or commentary to the Site are subject to the
              Code of Conduct. The Company reserves the right to suspend
              privileges without notice for behavior that it deems not to be in
            ...
            <p>
              ...
              click here. Please note that some content on this site is owned or
              co-owned by third parties, and may carry additional copyright
              restrictions. This is especially true for photos and illustrations
              — many images have been purchased from shutterstock.com and are
              licensed only for use on this site, while others carry different
              Creative Commons licenses that have been determined by their
              owners. We have made every effort to clearly label such content,
              regardless of type, but images should be approached with special
              care. If you have any questions about citing or re-using DataKind
          ...
          <section className="mb-6">
            ...
            <p>
              ...
              layouts, arrangements, displays, illustrations, audio and video
              clips, HTML, and files (collectively, the “Content”), are the
              property of the Company and/or its affiliates or licensors and are
              protected by copyright, patent and/or other proprietary
              intellectual property rights under United States and foreign law.
            </p>
            <p>
              Company logos, trademarks and service marks which may appear on
              the Site (“Marks”), are the property of the Company and are
              protected under United States and foreign laws. All other
              trademarks, service marks and logos used on the Site, with or
              without attribution, are the trademarks, service marks or logos of
